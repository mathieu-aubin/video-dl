...
[ "$four" != "" ] && for a in $four; do echo "<h2><a href=\"$a\">Qualit&#224;  minima (`size $a`)</a></h2>
<br>";done


[ "$six" != "" ] && for b in $six; do echo "<h2><a href=\"$b\">Bassa qualit&#224; (`size $b`)</a></h2>
<br>";done



[ "$eight" != "" ] && for c in $eight; do echo "<h2><a href=\"$c\">Qualit&#224; medio-bassa (`size $c`)</a></h2>
<br>";done


[ "$twelve" != "" ] && for d in $twelve; do echo "<h2><a href=\"$d\">Qualit&#224; media (`size $d`)</a></h2>
<br>";done


[ "$fifteen" != "" ] && for e in $fifteen; do echo "<h2><a href=\"$e\">Qualit&#224; medio-alta (`size $e`)</a></h2>
<br>";done


[ "$eighteen" != "" ] && for f in $eighteen; do echo "<h2><a href=\"$f\">Alta qualit&#224; (`size $f`)</a></h2>
<br>";done


[ "$normal" != "" ] && for g in $normal; do echo "<h2><a href=\"$g\">Qualit&#224; normale (`size $g`)</a></h2>
<br>";done
